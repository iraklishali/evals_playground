...
def read_dataset(
    ...
    # read dataset. we INCLUDE ONLY the samples that required internet access
    # and have been excluded from the GDM paper (https://arxiv.org/pdf/2403.13793)
    include_only = [
        1,
        9,
        14,
    ...
    return json_dataset(
        ...
        lambda sample: sample.id in include_only 
        and (not sample.id in exclude)
